...
export const Formatter = {
    add(styleObject: any, ...values: string[]): any[] {
        ...
        let horizontalStyleFinal: any = {};
        let verticalStyleFinal: any = {};
        ...
        let finalStyles: any[] = [];
        if (Object.keys(horizontalStyleFinal).length > 0) {
            finalStyles.push(horizontalStyleFinal);
        }
        if (Object.keys(verticalStyleFinal).length > 0) {
